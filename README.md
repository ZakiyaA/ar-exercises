...
1. Add validations to two models to enforce the following business rules:
  ...
  * BONUS: Stores must carry at least one of the men's or women's apparel (hint: use a [custom validation method](http://guides.rubyonrails.org/active_1record_validations.html#custom-methods) - **don't** use a `Validator` class)
